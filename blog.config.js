...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WENJIN GLOBAL', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Wenjin International Supply Chain', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wenjinglobal.com', // 网站地址
