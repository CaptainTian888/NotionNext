...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '顺为国际集团SHINEVISTA GLOBAL GROUP', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'SHINEVISTA GLOBAL GROUP LIMITED, // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.tianzeqi.com', // 网站地址
